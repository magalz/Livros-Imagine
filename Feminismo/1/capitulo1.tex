...
\addcontentsline{toc}{section}{Pioneiras: A história das primeiras mulheres na análise do \\comportamento no Brasil}
\addcontentsline{toc}{subsection}{\textbf{Autoras:} \textit{Gabriela Jheniffer Teixeira Silva \& Ana Arantes}} 
\begin{flushright}
\begin{small}
...
\vfill
\section*{Psicologia: Uma profissão feminina, mas uma ciência masculina}\sectionmark{Psicologia: Uma profissão feminina, mas uma ciência masculina}
...
\section*{Por que estudar a história da Análise do Comportamento no Brasil?}\sectionmark{Por que estudar a história da Análise do Comportamento no Brasil?}
...
\section*{Presença e participação feminina na Análise do Comportamento brasileira}\sectionmark{Presença e participação feminina na Análise do Comportamento brasileira}
