...
\addcontentsline{toc}{section}{Contribuições do feminismo para a compreensão e intervenção em casos de relacionamento abusivo}
\addcontentsline{toc}{subsection}{\textbf{Autora:} \textit{Analu Ianik Costa}}
\begin{flushright}
\begin{small}
    Analu Ianik Costa
\end{small}
...
\section*{Relacionamento abusivo}\sectionmark{Relacionamento abusivo}
...
\begin{figure}[ht]
    ...
    \captionof{figure}{Representação do ciclo da violência em relacionamentos abusivos. Fonte: \url{https://tinyurl.com/fem100}}
\end{figure}
...
\section*{Terapia feminista}\sectionmark{Terapia feminista}
...
\section*{Psicoterapia Analítica Funcional e feminismo}\sectionmark{Psicoterapia Analítica Funcional e feminismo}
...
% \usepackage{graphicx}
\begin{table}[h]
    \caption{Modelo ADDRESSING. Hays, 2001}
    \label{tabela021}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{@{}lll@{}}
    \toprule
...
\section*{Estratégias psicoterápicas}\sectionmark{Estratégias psicoterápicas}
