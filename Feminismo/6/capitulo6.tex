...
\addcontentsline{toc}{section}{O empoderamento das mulheres sob uma perspectiva analítico-comportamental}
\addcontentsline{toc}{subsection}{\textbf{Autora:} \textit{Aline Guimarães Couto}}
...
\section*{Considerações sobre a metodologia empregada}\sectionmark{Considerações sobre a metodologia empregada}
...
\section*{Empoderamento com base em estados internos}\sectionmark{Empoderamento com base em estados internos}

Na literatura feminista consultada, podemos observar o \textit{empoderamen\-to com base em estados internos} como a classificação que, em geral, considera comportamentos relacionados à expressão verbal de sentimentos das mulheres estudadas como característicos do processo de empoderamento. Alguns dos trechos encontrados na literatura realizam descrições verbais das mulheres como empoderadas em determinado contexto a partir do momento em que elas adquirem consciência do controle exercido por práticas culturais machistas.
...
\section*{Empoderamento com base no contracontrole}\sectionmark{Empoderamento com base no contracontrole}
