...
\begin{flushright}
\begin{scriptsize}
Renata da Conceição da Silva Pinheiro \& Cláudia Kami Bastos Oshiro\blfootnote{Agradecemos à Psic. Ma. Priscila Rolim pelas contribuições durante a construção deste capítulo.}
\end{scriptsize}
\vspace{1cm}
\end{flushright}
